...
/* RTC alarm duration used for power mode
 * Possible options:
 *   - RTC_ALARM_7P8125MS
 *   - RTC_ALARM_15P625MS
 *   - RTC_ALARM_31P25MS
 ...
 *   - RTC_ALARM_ZERO
 *   - etc. */
#define RTC_ALARM_DURATION              RTC_ALARM_32S
...
void RTC_CLOCK_Init(uint32_t reload_value);
...
void Wakeup_Source_Reconfig(void);
